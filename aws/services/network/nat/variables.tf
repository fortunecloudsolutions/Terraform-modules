...
variable "subnet_id" {
  ...
  type        = list(string)
  # as a temporary change modified the "subnet_id": list type and in the main.tf file we will use the first element in the subnet var.subnet[0] 
  # This is for all EC2 instances to accomodate subnet input coming as list rather than string. 
}
