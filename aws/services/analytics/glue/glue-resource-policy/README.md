...
|-----------------------------------|------------------------------------------------------------------------------------------|
| `region`                          | us-east-2                                                                                | 
| `policy`                          | {\n\"Version\":\"2012-10-17\",\n\"Statement\":[\n{\n\"Effect\":\"Allow\",\n\"Principal\": {\n\"AWS\":[\"arn:aws:iam::046692759124:user/sankireddy\"]\n},\n\"Action\":[\n\"glue:Get*\"],\n\"Resource\":[\"arn:aws:glue:us-east-2:046692759124:table/catalog-test-database/test\"]\n}\n]\n}                                                                                |
...
* :link: [Terraform](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/glue_registry)
