...
data "template_file" "init" {
  ...
  vars = {
    outputFile  = "'${var.outputFile}'"
    awsFile     = "'${var.awsFile}'"
    bucket      = "'${var.bucketname}'"
    s3Key       = "'${data.vault_aws_access_credentials.creds.access_key}'"
    s3Secret    = "'${data.vault_aws_access_credentials.creds.secret_key}'"
...
module "launch_template" {
  source                               = "../../../../modules/auto-scaling-group/launch-template-linux"
  tags                                 = var.tags
