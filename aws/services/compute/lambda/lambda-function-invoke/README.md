...
# *Service Description*
:hash: Use this resource to invoke a lambda function. The lambda function is invoked with the RequestResponse invocation type.
...
| `input` | `string` | true | JSON payload to the lambda function. |
...
* :link: [Terraform](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lambda_invocation#argument-reference)